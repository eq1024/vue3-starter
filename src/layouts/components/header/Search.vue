...
<template>
  ...
  <n-el
    class="b-solid cursor-pointer border b-[var(--border-color)] rounded-[var(--border-radius)] px-[10px] py-[6px] search"
    @click="openModal"
  >
    <n-space gap="2" justify="center" align="center" class="shrink-0 min-w-max">
      <icon-park-outline-search />
      <div class="text-[var(--placeholder-color)]">
        {{ $t('app.searchPlaceholder') }}
      </div>
      <n-tag size="small" class="font-mono rounded-[var(--border-radius)]  cursor-pointer">
        Ctrl+K
      </n-tag>
    </n-space>
  </n-el>
  ...
  >
    ...
    <n-scrollbar ref="scrollbarRef" class="h-[450px]">
      ...
      <n-empty v-else size="large" class="h-[450px] flex justify-center items-center" />
    </n-scrollbar>
